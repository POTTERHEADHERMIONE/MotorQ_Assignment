                        ...
                        <Carousel ref={sliderRef}>
                          <Carousel.Item interval={3000}>
                            <Carousel.Caption className="carousel-caption text-dark text-start">
                              <h2 className="fs-1 fw-bold mb-2"><span>Car Rent</span><br/><span className="primary-color">Made</span></h2>
                          ...
                          <Carousel.Item interval={3000}>
                            <Carousel.Caption className="carousel-caption text-dark text-start">
                              <h2 className="fs-1 fw-bold mb-2"><span>Spalits </span><br/><span className="primary-color">Car Rental</span></h2>
                              <p className="fs-3 m-0">
                                Solution to car rentals
                              </p>
                            </Carousel.Caption>
                          </Carousel.Item>
                        </Carousel>
